...
class TestImgwrenchMainCli(unittest.TestCase):
    ...
    def test_pipeline(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(
                cli_imgwrench,
                ["-i", "images.txt", pipelinetest, pipelinetest, pipelinetest],
            )
    ...
    def test_increment(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(
                cli_imgwrench,
                ["-c", increment, "-p", prefix, "-d", 4, "-i", "images.txt", "save"],
            )
            self.assertEqual(0, result.exit_code)
            for i in range(10):
        ...
        with self.runner.isolated_filesystem():
            ...
            with open("images.txt", "w") as f:
                for i in range(20):
                    f.write("pixel1x1.jpg\n")
            result = self.runner.invoke(
                cli_imgwrench, ["-p", prefix, "-d", 7, "-i", "images.txt", "save"]
            )
            self.assertEqual(0, result.exit_code)
            for i in range(20):
    ...
    def test_png_loading(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            with open("images.txt", "w") as f:
                f.write("png1x1.png\n")
            result = self.runner.invoke(
                cli_imgwrench, ["-p", prefix, "-d", 4, "-i", "images.txt", "save"]
            )
            self.assertEqual(0, result.exit_code)
    ...
    def test_png_saving(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(
                cli_imgwrench,
                ["-p", prefix, "-d", 4, "--png", "-i", "images.txt", "save"],
            )
            self.assertEqual(0, result.exit_code)
    ...
    def test_saving_of_exif_metadata(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(
                cli_imgwrench,
                ["-p", "exif_", "-d", 4, "-e", "-i", "images.txt", "resize", "-m", 100],
            )
            self.assertEqual(0, result.exit_code)
            ...
            # save without exif
            result = self.runner.invoke(
                cli_imgwrench, ["-p", "no_exif_", "-d", 4, "-i", "images.txt", "save"]
            )
    ...
    def test_image_rotation(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result = self.runner.invoke(
                cli_imgwrench,
                ["-p", "exif_", "-d", 4, "-e", "-i", "images.txt", "save"],
            )
            self.assertEqual(0, result.exit_code)
            fname = "{}{:04d}.jpg".format("exif_", 0)
            self.assertTrue(os.path.exists(fname), fname + " missing")
    ...
    def test_loading_broken_exif(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            with open("images.txt", "w") as f:
                f.write(fname + "\n")
            result = self.runner.invoke(
                cli_imgwrench, ["-k", "-i", "images.txt", "-o", str(outdir), "resize"]
            )
            self.assertEqual(0, result.exit_code)
